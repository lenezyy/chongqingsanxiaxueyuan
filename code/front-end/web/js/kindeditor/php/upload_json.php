...
//文件保存目录路径
$save_path = $php_path . '../../../uploads/editorfiles/';
//文件保存目录URL
$save_url = $php_url . '../../../uploads/editorfiles/';
//定义允许上传的文件扩展名
$ext_arr = array(
...
if (empty($_FILES) === false) {
	...
	if (move_uploaded_file($tmp_name, $file_path) === false) {
		...
		$sql = "INSERT INTO `".$db['default']['dbprefix']."files` VALUES ('NULL', '".$file_name."', '".$file_path."','".date("Y-m-d H:i:s")."')";
		mysql_query($sql);
		*/
